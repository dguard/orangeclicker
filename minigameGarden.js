		...
		*/
		M.plants={
			...
			'thumbcorn':{
				...
				effsStr:'<div class="green">&bull; +2% oranges per click</div>',
			...
			'gildmillet':{
				...
				effsStr:'<div class="green">&bull; +1% golden orange gains</div><div class="green">&bull; +0.1% golden orange effect duration</div>',
			...
			'clover':{
				...
				effsStr:'<div class="green">&bull; +1% golden orange frequency</div>',
			...
			'goldenClover':{
				...
				mature:50,
				children:[],
				effsStr:'<div class="green">&bull; +3% golden orange frequency</div>',
			...
			'shimmerlily':{
				...
				effsStr:'<div class="green">&bull; +1% golden orange gains</div><div class="green">&bull; +1% golden orange frequency</div><div class="green">&bull; +1% random drops</div>',
			...
			'elderwort':{
				...
				effsStr:'<div class="green">&bull; +1% wrath orange gains</div><div class="green">&bull; +1% wrath orange frequency</div><div class="green">&bull; +1% grandma CpS</div><div class="green">&bull; immortal</div><div class="gray">&bull; surrounding plants (3x3) age 3% faster</div>',
			...
			'bakeberry':{
				...
				onHarvest:function(x,y,age)
				{
					if (age>=this.mature)
					{
						var moni=Math.min(Game.oranges*0.03,Game.orangesPs*60*30);
						if (moni!=0)
						{
							Game.Earn(moni);
							Game.Popup('(Bakeberry)<br>+'+Beautify(moni)+' oranges!',Game.mouseX,Game.mouseY);
						}
						M.dropUpgrade('Bakeberry oranges',0.015);
					}
				},
			},
			'chocoroot':{
				...
				onHarvest:function(x,y,age)
				{
					if (age>=this.mature)
					{
						var moni=Math.min(Game.oranges*0.03,Game.orangesPs*60*3);
						if (moni!=0)
						{
							Game.Earn(moni);
							Game.Popup('(Chocoroot)<br>+'+Beautify(moni)+' oranges!',Game.mouseX,Game.mouseY);
						}
					}
				},
			},
			'whiteChocoroot':{
				...
				effsStr:'<div class="green">&bull; +1% golden orange gains</div><div class="green">&bull; harvest when mature for +3 minutes of CpS (max. 3% of bank)</div><div class="green">&bull; predictable growth</div>',
				...
				onHarvest:function(x,y,age)
				{
					if (age>=this.mature)
					{
						...
						{
							Game.Earn(moni);
							Game.Popup('(White chocoroot)<br>+'+Beautify(moni)+' oranges!',Game.mouseX,Game.mouseY);
						}
					}
				},
			},
			...
			'drowsyfern':{
				...
				mature:30,
				children:[],
				effsStr:'<div class="green">&bull; +3% CpS</div><div class="red">&bull; -5% oranges per click</div><div class="red">&bull; -10% golden orange frequency</div>',
			...
			'wardlichen':{
				...
				mature:65,
				children:['wardlichen'],
				effsStr:'<div class="gray">&bull; 2% less wrath oranges</div><div class="gray">&bull; wrinklers spawn 15% slower</div>',
			...
			'queenbeet':{
				...
				effsStr:'<div class="green">&bull; +0.3% golden orange effect duration</div><div class="red">&bull; -2% CpS</div><div class="green">&bull; harvest when mature for +1 hour of CpS (max. 4% of bank)</div>',
				q:'A delicious taproot used to prepare high-grade white sugar. Entire countries once went to war over these.',
				onHarvest:function(x,y,age)
				{
					if (age>=this.mature)
					{
						var moni=Math.min(Game.oranges*0.04,Game.orangesPs*60*60);
						if (moni!=0)
						{
							Game.Earn(moni);
							Game.Popup('(Queenbeet)<br>+'+Beautify(moni)+' oranges!',Game.mouseX,Game.mouseY);
						}
					}
				},
			},
			...
			'duketater':{
				...
				onHarvest:function(x,y,age)
				{
					if (age>=this.mature)
					{
						var moni=Math.min(Game.oranges*0.08,Game.orangesPs*60*60*2);
						if (moni!=0)
						{
							Game.Earn(moni);
							Game.Popup('(Duketater)<br>+'+Beautify(moni)+' oranges!',Game.mouseX,Game.mouseY);
						}
						M.dropUpgrade('Duketater oranges',0.005);
					}
				},
			},
			'crumbspore':{
				...
				onDie:function(x,y)
				{
					var moni=Math.min(Game.oranges*0.01,Game.orangesPs*60)*Math.random();
					if (moni!=0)
					{
						Game.Earn(moni);
						Game.Popup('(Crumbspore)<br>+'+Beautify(moni)+' oranges!',Game.mouseX,Game.mouseY);
					}
				},
			},
			'doughshroom':{
				...
				onDie:function(x,y)
				{
					var moni=Math.min(Game.oranges*0.03,Game.orangesPs*60*5)*Math.random();
					if (moni!=0)
					{
						Game.Earn(moni);
						Game.Popup('(Doughshroom)<br>+'+Beautify(moni)+' oranges!',Game.mouseX,Game.mouseY);
					}
				},
			},
			'glovemorel':{
				...
				mature:80,
				children:[],
				effsStr:'<div class="green">&bull; +4% oranges per click</div><div class="green">&bull; +1% cursor CpS</div><div class="red">&bull; -1% CpS</div>',
			...
			'foolBolete':{
				...
				mature:50,
				children:[],
				effsStr:'<div class="green">&bull; +2% golden orange frequency</div><div class="red">&bull; -5% golden orange gains</div><div class="red">&bull; -2% golden orange duration</div><div class="red">&bull; -2% golden orange effect duration</div>',
			...
			'greenRot':{
				...
				effsStr:'<div class="green">&bull; +0.5% golden orange duration</div><div class="green">&bull; +1% golden orange frequency</div><div class="green">&bull; +1% random drops</div>',
				...
				for (var y=0;y<6;y++)
				{
					for (var x=0;x<6;x++)
					{
						...
						if (tile[0]>0)
						{
							...
							else if (name=='gildmillet') {effs.goldenOrangeGain+=0.01*mult;effs.goldenOrangeEffDur+=0.001*mult;}
							else if (name=='clover') effs.goldenOrangeFreq+=0.01*mult;
							else if (name=='goldenClover') effs.goldenOrangeFreq+=0.03*mult;
							else if (name=='shimmerlily') {effs.goldenOrangeGain+=0.01*mult;effs.goldenOrangeFreq+=0.01*mult;effs.itemDrops+=0.01*mult;}
							else if (name=='elderwort') {effs.wrathOrangeGain+=0.01*mult;effs.wrathOrangeFreq+=0.01*mult;effs.grandmaCps+=0.01*mult;}
							else if (name=='bakeberry') effs.cps+=0.01*mult;
							else if (name=='chocoroot') effs.cps+=0.01*mult;
							else if (name=='whiteChocoroot') effs.goldenOrangeGain+=0.01*mult;
							...
							else if (name=='drowsyfern') {effs.cps+=0.03*mult;effs.click*=1-0.05*mult;effs.goldenOrangeFreq*=1-0.1*mult;}
							else if (name=='wardlichen') {effs.wrinklerSpawn*=1-0.15*mult;effs.wrathOrangeFreq*=1-0.02*mult;}
							else if (name=='keenmoss') {effs.itemDrops+=0.03*mult;}
							else if (name=='queenbeet') {effs.goldenOrangeEffDur+=0.003*mult;effs.cps*=1-0.02*mult;}
							...
							else if (name=='foolBolete') {effs.goldenOrangeFreq+=0.02*mult;effs.goldenOrangeGain*=1-0.05*mult;effs.goldenOrangeDur*=1-0.02*mult;effs.goldenOrangeEffDur*=1-0.02*mult;}
							else if (name=='wrinklegill') {effs.wrinklerSpawn+=0.02*mult;effs.wrinklerEat+=0.01*mult;}
							else if (name=='greenRot') {effs.goldenOrangeDur+=0.005*mult;effs.goldenOrangeFreq+=0.01*mult;effs.itemDrops+=0.01*mult;}
			...
			'info':{
				...
				descFunc:function()
				{
					...
					else
					{
						var effs={
							cps:{n:'CpS'},
							click:{n:'oranges/click'},
							cursorCps:{n:'cursor CpS'},
							grandmaCps:{n:'grandma CpS'},
							goldenOrangeGain:{n:'golden orange gains'},
							goldenOrangeFreq:{n:'golden orange frequency'},
							goldenOrangeDur:{n:'golden orange duration'},
							goldenOrangeEffDur:{n:'golden orange effect duration'},
							wrathOrangeGain:{n:'wrath orange gains'},
							wrathOrangeFreq:{n:'wrath orange frequency'},
							wrathOrangeDur:{n:'wrath orange duration'},
							wrathOrangeEffDur:{n:'wrath orange effect duration'},
							reindeerGain:{n:'reindeer gains'},
							reindeerFreq:{n:'reindeer orange frequency'},
							reindeerDur:{n:'reindeer orange duration'},
		...
		M.getCost=function(me)
		{
			...
			return Math.max(me.costM,Game.orangesPs*me.cost*60)*(Game.HasAchiev('Seedless to nay')?0.95:1);
		}
		...
		{
			if (Game.oranges>=M.getCost(me)) return true; else return false;
		}
		...
		M.seedTooltip=function(id)
		{
			return function(){
				...
				var str='<div style="padding:8px 4px;min-width:400px;">'+
					...
					(me.plantable?('<div style="float:right;text-align:right;width:100px;"><small>Planting cost :</small><br><span class="price'+(M.canPlant(me)?'':' disabled')+'">'+Beautify(Math.round(shortenNumber(M.getCost(me))))+'</span><br><small>'+Game.sayTime(me.cost*60*30,-1)+' of CpS,<br>minimum '+Beautify(me.costM)+' oranges</small></div>'):'')+
